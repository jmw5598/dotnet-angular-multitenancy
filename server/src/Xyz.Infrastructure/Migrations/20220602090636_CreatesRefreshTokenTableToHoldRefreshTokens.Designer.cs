...
namespace Xyz.Infrastructure.Migrations
{
    ...
    [Migration("20220602090636_CreatesRefreshTokenTableToHoldRefreshTokens")]
    partial class CreatesRefreshTokenTableToHoldRefreshTokens
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f2fb624d-193b-45cc-b54c-475cd0edcd78",
                            Name = "ROOT",
                            NormalizedName = "ROOT"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "8e33ee6c-be53-424b-9177-9543ecf90b98",
                            Name = "ADMIN",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9ea7d496-988c-4e7d-8dae-f215de561ea2",
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8dc21503-d697-4989-8916-54d6c733c25a",
                            Email = "jmw5598@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "JMW5598@gmail.com",
                            NormalizedUserName = "JMW5598@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEN1mCEkZS7cLuZfGgMvCNS0OIzwZ0KIfwHWgx2M2kWANYJlTHsBM7DbQTcfYEIK6xw==",
                            PhoneNumberConfirmed = false,
                            ProfileId = new Guid("a716ef02-8030-4eba-a61b-9fd4020ca579"),
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193"),
                            RoleId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6caac27")
                        },
                        new
                        {
                            UserId = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193"),
                            RoleId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6caac28")
                        },
                        new
                        {
                            UserId = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193"),
                            RoleId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6caac22")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a716ef02-8030-4eba-a61b-9fd4020ca579"),
                            FirstName = "Jason",
                            LastName = "White"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.UserModulePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("032c5065-167b-407a-b3d7-0422810c71f0"),
                            HasAccess = true,
                            ModulePermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc16"),
                            UserId = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193")
                        },
                        new
                        {
                            Id = new Guid("7d500527-d1ce-45df-b027-6ac778182f36"),
                            HasAccess = true,
                            ModulePermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc27"),
                            UserId = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193")
                        },
                        new
                        {
                            Id = new Guid("f67ff374-7c21-4ad1-9dac-9ddcc4a45e52"),
                            HasAccess = true,
                            ModulePermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc17"),
                            UserId = new Guid("1b0ba72f-9d36-41a0-87d1-98484f91b193")
                        });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c3920c92-d728-487f-a58c-8ee873b3cea6"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc11"),
                            UserModulePermissionId = new Guid("032c5065-167b-407a-b3d7-0422810c71f0")
                        },
                        new
                        {
                            Id = new Guid("1a5bc43b-504d-450d-8289-c06fee39f554"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacd27"),
                            UserModulePermissionId = new Guid("032c5065-167b-407a-b3d7-0422810c71f0")
                        },
                        new
                        {
                            Id = new Guid("2c2aaab5-1da2-4f60-83cc-32089044c0bb"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc22"),
                            UserModulePermissionId = new Guid("7d500527-d1ce-45df-b027-6ac778182f36")
                        },
                        new
                        {
                            Id = new Guid("d70742c7-9b12-49c7-90ca-1712c827aa64"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc21"),
                            UserModulePermissionId = new Guid("7d500527-d1ce-45df-b027-6ac778182f36")
                        },
                        new
                        {
                            Id = new Guid("9ccf3065-c7b7-45f3-906f-02dafc956fdf"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc07"),
                            UserModulePermissionId = new Guid("f67ff374-7c21-4ad1-9dac-9ddcc4a45e52")
                        });
                });
