...
namespace Xyz.Infrastructure.Migrations
{
    ...
    [Migration("20220530111604_MovesIdentityEntitiesToTenantDatabase")]
    partial class MovesIdentityEntitiesToTenantDatabase
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("66e15c21-cd33-4f94-8b49-765d689deb1d"),
                            ConcurrencyStamp = "c44bfa05-ace3-4a31-bd9a-0de0739905cb",
                            Name = "ROOT",
                            NormalizedName = "ROOT"
                        },
                        new
                        {
                            Id = new Guid("35072c12-05ff-4cda-b1b0-8405e49fbeb6"),
                            ConcurrencyStamp = "43bcf0f5-7643-43d7-8e73-05a32d6a5cdf",
                            Name = "ADMIN",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("2f3d6be4-2eab-4011-aed9-fc81fea7c130"),
                            ConcurrencyStamp = "cf0f5280-d0e7-4a22-b16b-47fe6fb48878",
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f5e67db3-e447-4357-961a-892ce1d5b6f8"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2a9783b8-ae03-4707-bf55-c4c303f7d035",
                            Email = "jmw5598@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "JMW5598@gmail.com",
                            NormalizedUserName = "JMW5598@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAELwCJjmbfp6nIH70iomkE/DmTPoTbdZ9RMFDPrgietY6RTCrBcjEQOlRaIWzAAtPHw==",
                            PhoneNumberConfirmed = false,
                            ProfileId = new Guid("58b69496-609d-4777-8ee6-1c2a6f1d14e0"),
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("f5e67db3-e447-4357-961a-892ce1d5b6f8"),
                            RoleId = new Guid("66e15c21-cd33-4f94-8b49-765d689deb1d")
                        },
                        new
                        {
                            UserId = new Guid("f5e67db3-e447-4357-961a-892ce1d5b6f8"),
                            RoleId = new Guid("35072c12-05ff-4cda-b1b0-8405e49fbeb6")
                        },
                        new
                        {
                            UserId = new Guid("f5e67db3-e447-4357-961a-892ce1d5b6f8"),
                            RoleId = new Guid("2f3d6be4-2eab-4011-aed9-fc81fea7c130")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("58b69496-609d-4777-8ee6-1c2a6f1d14e0"),
                            FirstName = "Jason",
                            LastName = "White"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.ModulePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9184f74-cf03-4a9e-9018-0c9643ff3a04"),
                            Name = "Administration Module"
                        },
                        new
                        {
                            Id = new Guid("4cbbada9-b587-4a02-8368-7f76eaf38eea"),
                            Name = "Dashboard Module"
                        },
                        new
                        {
                            Id = new Guid("e55d82c2-5f3b-456d-bd18-9cd0abcd687d"),
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5ebed63a-e080-462b-a559-f641e5b5e0dd"),
                            ModulePermissionId = new Guid("e9184f74-cf03-4a9e-9018-0c9643ff3a04"),
                            Name = "Settings"
                        },
                        new
                        {
                            Id = new Guid("b07b71df-cd8b-4714-aad5-2ee334216f7e"),
                            ModulePermissionId = new Guid("e9184f74-cf03-4a9e-9018-0c9643ff3a04"),
                            Name = "User Accounts"
                        },
                        new
                        {
                            Id = new Guid("7baa7483-440c-48de-ad93-540671d4d9ae"),
                            ModulePermissionId = new Guid("4cbbada9-b587-4a02-8368-7f76eaf38eea"),
                            Name = "Dashboard Overview"
                        },
                        new
                        {
                            Id = new Guid("d96e7a54-98c3-4c2b-b19b-1a2774e34f89"),
                            ModulePermissionId = new Guid("e55d82c2-5f3b-456d-bd18-9cd0abcd687d"),
                            Name = "Security General"
                        },
                        new
                        {
                            Id = new Guid("d97f39a8-4d27-4d2a-8160-29418cb4974f"),
                            ModulePermissionId = new Guid("e55d82c2-5f3b-456d-bd18-9cd0abcd687d"),
