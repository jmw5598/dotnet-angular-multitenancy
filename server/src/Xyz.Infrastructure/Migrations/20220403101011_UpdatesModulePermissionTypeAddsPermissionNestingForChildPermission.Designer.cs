...
namespace Xyz.Infrastructure.Migrations
{
    ...
    [Migration("20220403101011_UpdatesModulePermissionTypeAddsPermissionNestingForChildPermission")]
    partial class UpdatesModulePermissionTypeAddsPermissionNestingForChildPermission
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b3247b2-76d7-4457-80aa-5e7538a9108c"),
                            Name = "Settings Module",
                            Type = "SETTINGS"
                        },
                        new
                        {
                            Id = new Guid("8554d348-9156-4063-8b72-aacd4a0be046"),
                            Name = "User Accounts Module",
                            ParentPermissionId = new Guid("3b3247b2-76d7-4457-80aa-5e7538a9108c"),
                            Type = "USER_ACCOUNTS"
                        });
                });
