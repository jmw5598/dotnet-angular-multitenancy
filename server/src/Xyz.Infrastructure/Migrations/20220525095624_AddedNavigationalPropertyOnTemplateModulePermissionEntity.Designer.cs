...
namespace Xyz.Infrastructure.Migrations
{
    ...
    [Migration("20220525095624_AddedNavigationalPropertyOnTemplateModulePermissionEntity")]
    partial class AddedNavigationalPropertyOnTemplateModulePermissionEntity
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.ModulePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("380abf0f-8863-4161-8e10-bc2ce75acd9e"),
                            Name = "Administration Module"
                        },
                        new
                        {
                            Id = new Guid("29e4d578-9ed5-4acf-9538-13f7b2d36ad8"),
                            Name = "Dashboard Module"
                        },
                        new
                        {
                            Id = new Guid("f5307d0f-9c16-43db-9d27-5d5f837f9526"),
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("72d9c873-e7d2-41b6-9150-1384746ac4ab"),
                            ModulePermissionId = new Guid("380abf0f-8863-4161-8e10-bc2ce75acd9e"),
                            Name = "Settings"
                        },
                        new
                        {
                            Id = new Guid("4ae259e8-2628-476d-8a0e-ddb665163d3d"),
                            ModulePermissionId = new Guid("380abf0f-8863-4161-8e10-bc2ce75acd9e"),
                            Name = "User Accounts"
                        },
                        new
                        {
                            Id = new Guid("c856c8be-f628-4fa3-b2e5-905a16f1cfa0"),
                            ModulePermissionId = new Guid("29e4d578-9ed5-4acf-9538-13f7b2d36ad8"),
                            Name = "Dashboard Overview"
                        },
                        new
                        {
                            Id = new Guid("276b957c-40a2-4cd8-b30e-20d20a522408"),
                            ModulePermissionId = new Guid("f5307d0f-9c16-43db-9d27-5d5f837f9526"),
                            Name = "Security General"
                        },
                        new
                        {
                            Id = new Guid("d0537ea4-6f20-4bcd-9e36-10044d490296"),
                            ModulePermissionId = new Guid("f5307d0f-9c16-43db-9d27-5d5f837f9526"),
