...
namespace Xyz.Infrastructure.Migrations
{
    ...
    [Migration("20220530220012_UpdatesSeedDataToSeedUserModulePermissionsAndUserPermissions")]
    partial class UpdatesSeedDataToSeedUserModulePermissionsAndUserPermissions
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "221022b3-38f3-4779-9061-47e379a29fbd",
                            Name = "ROOT",
                            NormalizedName = "ROOT"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "b593d6fc-922d-427c-8fe4-4c00ef996219",
                            Name = "ADMIN",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a915dc6d-6e24-441e-b102-73830a7a5629",
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d63125c0-4c0d-459b-bf19-7be15ba38405"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a60d68f6-c174-4788-9e4c-64d0061b2fbf",
                            Email = "jmw5598@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "JMW5598@gmail.com",
                            NormalizedUserName = "JMW5598@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAECYCojMtCjiWOiWkC9mLBIfrGmPaJK4C70LZmB4vd7TNAx8KGzHMwingwx07kOF6+w==",
                            PhoneNumberConfirmed = false,
                            ProfileId = new Guid("233f9479-34e3-46f3-b992-b70897ad50a1"),
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("d63125c0-4c0d-459b-bf19-7be15ba38405"),
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Identity.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("233f9479-34e3-46f3-b992-b70897ad50a1"),
                            FirstName = "Jason",
                            LastName = "White"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.UserModulePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3609c2ab-d858-4ba9-ae9a-9a08c5749e93"),
                            HasAccess = true,
                            ModulePermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc16"),
                            UserId = new Guid("d63125c0-4c0d-459b-bf19-7be15ba38405")
                        },
                        new
                        {
                            Id = new Guid("effd8225-334b-4700-a874-d33eb840fa6f"),
                            HasAccess = true,
                            ModulePermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc27"),
                            UserId = new Guid("d63125c0-4c0d-459b-bf19-7be15ba38405")
                        },
                        new
                        {
                            Id = new Guid("990d6385-fff8-4559-a549-0b8451b426b3"),
                            HasAccess = true,
                            ModulePermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc17"),
                            UserId = new Guid("d63125c0-4c0d-459b-bf19-7be15ba38405")
                        });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.UserPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f0ba657b-4dd7-45ba-b491-60422ddd8242"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc11"),
                            UserModulePermissionId = new Guid("3609c2ab-d858-4ba9-ae9a-9a08c5749e93")
                        },
                        new
                        {
                            Id = new Guid("c24d3f5c-45f5-4823-a02e-388f6602abae"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                        ...
                        new
                        {
                            Id = new Guid("cfa307d5-3ac8-4d2c-9686-84d5e4efeeb3"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc22"),
                            UserModulePermissionId = new Guid("effd8225-334b-4700-a874-d33eb840fa6f")
                        },
                        new
                        {
                            Id = new Guid("22f92323-ad90-4609-ad84-3b0724e1dc92"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                        ...
                        new
                        {
                            Id = new Guid("72e4c218-9278-4755-9445-204ba2d33a6f"),
                            CanCreate = true,
                            CanDelete = true,
                            CanRead = true,
                            CanUpdate = true,
                            PermissionId = new Guid("0d27494f-c802-4804-8ea4-9fb5e6cacc07"),
                            UserModulePermissionId = new Guid("990d6385-fff8-4559-a549-0b8451b426b3")
                        });
                });
