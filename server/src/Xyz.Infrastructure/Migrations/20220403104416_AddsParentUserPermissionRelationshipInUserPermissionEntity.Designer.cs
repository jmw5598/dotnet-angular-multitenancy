...
namespace Xyz.Infrastructure.Migrations
{
    ...
    [Migration("20220403104416_AddsParentUserPermissionRelationshipInUserPermissionEntity")]
    partial class AddsParentUserPermissionRelationshipInUserPermissionEntity
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Tenant.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8c5aa2bc-6376-4981-bfc5-247ec67df4f3"),
                            Name = "Settings Module",
                            Type = "SETTINGS"
                        },
                        new
                        {
                            Id = new Guid("99813fcd-1883-4f16-aa9e-1acabd4da77c"),
                            Name = "User Accounts Module",
                            ParentPermissionId = new Guid("8c5aa2bc-6376-4981-bfc5-247ec67df4f3"),
                            Type = "USER_ACCOUNTS"
                        });
                });
