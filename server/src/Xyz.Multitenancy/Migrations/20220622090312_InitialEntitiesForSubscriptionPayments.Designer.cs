...
namespace Xyz.Multitenancy.Migrations
{
    ...
    [Migration("20220622090312_InitialEntitiesForSubscriptionPayments")]
    partial class InitialEntitiesForSubscriptionPayments
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("62630716-da8a-46c0-81f1-696bcb6b31f0"),
                            Name = "Localhost"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4b3c1264-c6ce-4732-8d81-3a52245fa7e2"),
                            CompanyId = new Guid("62630716-da8a-46c0-81f1-696bcb6b31f0"),
                            ConnectionString = "Server=localhost;Port=5432;Database=xyz_localhost_company;User Id=xyz;Password=password;",
                            DisplayName = "Localhost",
                            DomainNames = "",
                            Guid = "98b4af39-e034-4d87-a2b4-532a1f3081e9",
                            IpAddresses = "",
                            IsActive = false,
                            IsConfigured = false,
                            Name = "localhost",
                            TenantPlanId = new Guid("a3e6c03a-cbaa-4956-9be0-1ccb573980da")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.TenantPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a3e6c03a-cbaa-4956-9be0-1ccb573980da"),
                            MaxUserCount = 2,
