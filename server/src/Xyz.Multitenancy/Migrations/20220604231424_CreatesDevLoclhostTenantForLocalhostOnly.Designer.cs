...
namespace Xyz.Multitenancy.Migrations
{
    ...
    [Migration("20220604231424_CreatesDevLoclhostTenantForLocalhostOnly")]
    partial class CreatesDevLoclhostTenantForLocalhostOnly
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b8ebd84-ad4c-4116-af4e-7e0f9a11e28c"),
                            Name = "Localhost"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1d69718-49ec-40fd-8e56-dfde58939106"),
                            MaxUserCount = 5,
                            Name = "Free",
                            Price = 0.00m,
                            RenewalRate = "MONTHLY"
                        ...
                        new
                        {
                            Id = new Guid("dae43468-feef-461c-92c8-700c544f7768"),
                            MaxUserCount = 10,
                            Name = "Basic",
                            Price = 0m,
                            RenewalRate = "MONTHLY"
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7ddd6135-04dd-4a3c-a212-f007d7403fb0"),
                            CompanyId = new Guid("3b8ebd84-ad4c-4116-af4e-7e0f9a11e28c"),
                            ConnectionString = "Server=localhost;Port=5432;Database=xyz_localhost_company;User Id=xyz;Password=password;",
                            DisplayName = "Localhost",
                            DomainNames = "",
                            Guid = "e379b848-2783-4251-9975-39bee96f5e1c",
                            IpAddresses = "",
                            IsActive = false,
                            IsConfigured = false,
                            Name = "localhost",
                            TenantPlanId = new Guid("bf8b3c2d-81f5-4337-a3de-1a785fa5998a")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.TenantPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bf8b3c2d-81f5-4337-a3de-1a785fa5998a"),
                            MaxUserCount = 10,
                            PlanId = new Guid("dae43468-feef-461c-92c8-700c544f7768"),
                            Price = 0m,
                            RenewalRate = "MONTHLY"
                        });
                });
