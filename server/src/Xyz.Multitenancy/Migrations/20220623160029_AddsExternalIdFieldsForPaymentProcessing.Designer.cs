...
namespace Xyz.Multitenancy.Migrations
{
    ...
    [Migration("20220623160029_AddsExternalIdFieldsForPaymentProcessing")]
    partial class AddsExternalIdFieldsForPaymentProcessing
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.BillingInvoice", b =>
                {
                    ...
                    b.HasIndex("ExternalTransactionId")
                        .IsUnique()
                        .HasDatabaseName("ix_billing_invoices_external_transaction_id");
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e256b5db-244f-4220-bfaa-4ec2df8245ae"),
                            Name = "Localhost"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6eaad41b-f1fe-4a9b-921f-7d413bc8155b"),
                            CompanyId = new Guid("e256b5db-244f-4220-bfaa-4ec2df8245ae"),
                            ConnectionString = "Server=localhost;Port=5432;Database=xyz_localhost_company;User Id=xyz;Password=password;",
                            DisplayName = "Localhost",
                            DomainNames = "",
                            Guid = "53e72ab1-3d7d-4560-a575-2af570c12d9b",
                            IpAddresses = "",
                            IsActive = false,
                            IsConfigured = false,
                            Name = "localhost",
                            TenantPlanId = new Guid("f6dff289-8af1-402f-a0c1-d12425aa9d84")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.TenantPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f6dff289-8af1-402f-a0c1-d12425aa9d84"),
                            MaxUserCount = 2,
