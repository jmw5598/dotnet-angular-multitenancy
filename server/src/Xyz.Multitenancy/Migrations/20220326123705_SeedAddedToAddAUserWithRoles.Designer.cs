...
namespace Xyz.Multitenancy.Migrations
{
    ...
    [Migration("20220326123705_SeedAddedToAddAUserWithRoles")]
    partial class SeedAddedToAddAUserWithRoles
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("03e9ba3a-aab8-42bc-8423-610fb09b1a28"),
                            RoleId = new Guid("8a3bde90-8e2d-45ac-b1de-5917a49e8c12")
                        },
                        new
                        {
                            UserId = new Guid("03e9ba3a-aab8-42bc-8423-610fb09b1a28"),
                            RoleId = new Guid("836bca09-b91d-423d-939c-3fd888e189c7")
                        },
                        new
                        {
                            UserId = new Guid("03e9ba3a-aab8-42bc-8423-610fb09b1a28"),
                            RoleId = new Guid("38d8a1ff-b45e-4113-ac9d-f209a749e441")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8a3bde90-8e2d-45ac-b1de-5917a49e8c12"),
                            ConcurrencyStamp = "673427a9-ad47-481a-b54a-7cea80629625",
                            Name = "ROOT",
                            NormalizedName = "ROOT"
                        },
                        new
                        {
                            Id = new Guid("836bca09-b91d-423d-939c-3fd888e189c7"),
                            ConcurrencyStamp = "6acf65ad-3e0d-419e-bd87-0cda3071ebb3",
                            Name = "ADMIN",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("38d8a1ff-b45e-4113-ac9d-f209a749e441"),
                            ConcurrencyStamp = "c9c1a6b3-cb61-436f-bb88-42b0fa94dec4",
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("03e9ba3a-aab8-42bc-8423-610fb09b1a28"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "82d11f08-48f4-413b-8f6f-9843c1667d3b",
                            Email = "jmw5598@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "JMW5598@gmail.com",
                            NormalizedUserName = "JMW5598@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEIScI7/QeISXlVC1KUyq+uWKi6qKa/VKA7iuyWBoSARnbpZOUcuXN/DdYJwE+YvOwQ==",
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Plan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1f3c2ce-f5e2-4f2d-a04f-5be1ce68fab3"),
                            MaxUserCount = 5,
                            Name = "Free",
                            Price = 0.00m,
                            RenewalRate = "MONTHLY"
