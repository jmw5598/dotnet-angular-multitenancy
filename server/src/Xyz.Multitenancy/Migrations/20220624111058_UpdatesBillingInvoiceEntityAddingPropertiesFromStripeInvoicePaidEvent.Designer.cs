...
namespace Xyz.Multitenancy.Migrations
{
    ...
    [Migration("20220624111058_UpdatesBillingInvoiceEntityAddingPropertiesFromStripeInvoicePaidEvent")]
    partial class UpdatesBillingInvoiceEntityAddingPropertiesFromStripeInvoicePaidEvent
    {
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a947ca34-848b-4464-9a1b-8db4ffd1643d"),
                            Name = "Localhost"
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("16762b1b-ac07-405b-ab25-bd8c24802a20"),
                            CompanyId = new Guid("a947ca34-848b-4464-9a1b-8db4ffd1643d"),
                            ConnectionString = "Server=localhost;Port=5432;Database=xyz_localhost_company;User Id=xyz;Password=password;",
                            DisplayName = "Localhost",
                            DomainNames = "",
                            Guid = "afa60b82-55f1-48e4-a88c-9081dfe42558",
                            IpAddresses = "",
                            IsActive = false,
                            IsConfigured = false,
                            Name = "localhost",
                            TenantPlanId = new Guid("e201b019-adbe-4bd7-bb91-d2fe6cb213c1")
                        });
                });
            ...
            modelBuilder.Entity("Xyz.Core.Entities.Multitenancy.TenantPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e201b019-adbe-4bd7-bb91-d2fe6cb213c1"),
                            MaxUserCount = 2,
